...
def ltask_data():
    ...
    def generate_ltask_data():
        try:
            ...
            print (f"{sys._getframe().f_code.co_name}: An exception of type {type(ex).__name__}. Arguments: {ex.args}"  )

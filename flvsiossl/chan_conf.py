...
p4w_host = '192.168.1.161'
p4w_port = '9000'

sio_PORT = int(p4w_port)
sio_HOST = p4w_host 
...
html_vars = {
    ...
    "sio_app": P4W_APP,
    "sio_port": sio_PORT,
    'longtask_run_url': f'https://{p4w_host}:{p4w_port}/{P4W_APP}/longtask_run'
}
